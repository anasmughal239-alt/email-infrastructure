  ...
  return (
    <div className="relative bg-white dark:bg-gray-900 overflow-hidden">
        ...
        <div className="relative z-10 pb-8 bg-white dark:bg-gray-900 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          ...
          <div className="pt-10 sm:pt-16 lg:pt-8 xl:pt-16">
            <div className="sm:text-center lg:text-left px-4 sm:px-8 xl:pl-0">
              ...
              >
                Boost productivity and simplify operations with our modern SaaS platform. 
                Designed for teams of all sizes to collaborate, manage, and grow efficiently.
              </motion.p>
              <motion.div 
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <div className="h-56 w-full bg-gradient-to-r from-blue-600 to-purple-600 sm:h-72 md:h-96 lg:w-full lg:h-full">
          <div className="w-full h-full bg-opacity-50 bg-white dark:bg-black dark:bg-opacity-40 backdrop-blur-sm flex items-center justify-center">
            <div className="relative w-3/4 h-3/4 bg-white dark:bg-gray-800 rounded-lg shadow-2xl overflow-hidden">
              <div className="absolute top-0 w-full h-1 bg-gradient-to-r from-blue-600 to-purple-600"></div>
              <div className="p-4">
